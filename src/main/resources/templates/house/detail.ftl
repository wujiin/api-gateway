                            ...
                            <div class="col-md-8 col-sm-12">
                                ...
                                <!-- /#floor-plans -->
                                  <section id="property-map">
                                     <header><h2>地图定位</h2></header>
                                     <div class="property-detail-map-wrapper">
                                         <div class="property-detail-map" id="allmap"></div>
                                     </div>
                                 </section>
                                        ...
                                        <section class="agent-form">
                                            <div class="col-md-7 col-sm-12">
                                                <aside class="agent-info clearfix">
                                                    <figure><a href="/agency/agentDetail?id=${(agent.id)!}"><img alt=""
                                                                                                                 src="${(agent.avatar)!}"></a>
                                                    </figure>
...
<script type="text/javascript">
    ...
    //创建一个圆
    var circle = new BMap.Circle(new BMap.Point(lon, lat), 500, {
        fillColor: "blue",
        strokeWeight: 1,
        fillOpacity: 0.3,
        strokeOpacity: 0.3
    ...
    function showInfo(thisMarker,point) {
        var url = "/house/navigation?id="+houseId;
        //获取点的信息
        var sContent =
                '<ul style="margin:0 0 5px 0;padding:0.2em 0">'
                +'<li style="line-height: 26px;font-size: 15px;"><span style="width: 50px;display: inline-block;">导航：</span><a href="'+url+'">详情</a></li>'
                +'</ul>';
